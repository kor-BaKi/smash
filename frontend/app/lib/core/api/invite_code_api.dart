...
import '../../features/invite/model/invite_code.dart';
import 'api_client.dart';
import 'api_exception.dart';

final inviteCodeApiProvider = Provider<InviteCodeApi>((ref) {
  return InviteCodeApi(ref.watch(dioProvider));
});

class InviteCodeApi {
  InviteCodeApi(this._dio);
