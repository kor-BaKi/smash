...
class ActivityApi {
  ...
  Future<List<TodayActivity>> getToday({
  ...
  Future<List<CarryoverCandidate>> getCarryoverCandidates(
    int activityId,
  ) async {
    try {
      final response = await _dio.get(
  ...
  Future<ActivityDetail> getActivityDetail(
    int activityId,
  ) async {
    try {
  ...
  Future<List<ActivitySummary>> getAdminActivities({
    String? date,
  }) async {
    try {
      final response = await _dio.get(
