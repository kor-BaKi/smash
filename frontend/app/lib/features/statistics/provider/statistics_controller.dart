...
import '../../../core/api/statistics_api.dart';
...
final fulfillmentTrendProvider = FutureProvider<List<MonthlyFulfillment>>((ref) {
  ...
  return ref.read(statisticsApiProvider).getFulfillmentTrend(
        groupId: groupId,
        fromYear: fromYear,
        fromMonth: fromMonth,
        toYear: toYear,
...
final groupComparisonProvider = FutureProvider<List<GroupComparisonItem>>((ref) {
  ...
  return ref.read(statisticsApiProvider).getGroupComparison(year, month);
});
...
final carryoverTrendProvider = FutureProvider<List<MonthlyCarryoverCount>>((ref) {
  ...
  final toYear = ref.watch(statisticsToYearProvider);
  final toMonth = ref.watch(statisticsToMonthProvider);
  return ref.read(statisticsApiProvider).getCarryoverTrend(
        fromYear: fromYear,
        fromMonth: fromMonth,
        toYear: toYear,
        toMonth: toMonth,
