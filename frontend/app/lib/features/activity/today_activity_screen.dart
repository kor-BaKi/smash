...
import 'today_activity_controller.dart';
...
class TodayActivityScreen extends ConsumerWidget {
  ...
  Future<void> _handleButtonTap(BuildContext context, WidgetRef ref, TodayActivity activity, ClientParticipationType type) async {
    ...
    final candidates = await ref.read(activityRepositoryProvider).getCarryoverCandidates(activity.activityId);
                                ...
                                children: [
                                  ...
                                  TextButton(
                                    onPressed: () => Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (_) => ActivityDetailScreen(activityId: activity.activityId),
                                      ),
                                    ),
